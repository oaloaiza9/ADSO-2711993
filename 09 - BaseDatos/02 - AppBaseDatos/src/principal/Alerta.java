...
public class Alerta extends javax.swing.JFrame {
    ...
    public void initAlternComponents(){
        ...
        Image img_icono = getToolkit().createImage( ClassLoader.getSystemResource("imagenes/"+((this.tipo.equalsIgnoreCase("warning"))? "icono_warning.png":"icono_correcto.png" )) );
        img_icono = img_icono.getScaledInstance(80, 80, Image.SCALE_SMOOTH);
        etqImagen.setIcon(new ImageIcon(img_icono));
        
        
        if (!this.tipo.equalsIgnoreCase("warning")) {
            etqTitulo.setText("Confirmación");
